  ...
  # choropleth legend 
    addLegendNumeric(
     # if using pipe to add this to leaflet map, leaving map causes issues; if map is assigned leaflet 'map' than no issue.
      ...
      title =
        HTML("<span style='font-weight:600; line-height: normal'>Net transfers</span><br><span style='font-size: 9pt; font-weight:100; line-height: normal'><br>Per 100 students within legal<br> settlement<br></span>"),
      shape = NULL,
