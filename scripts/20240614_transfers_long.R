...
# create dataframe using transfer data that contains one row for each transfer from settlement school to enrolled school from 2018 to 2024. Assign colors for mapping and plot creation.
...
# write to csv
write_csv(sxfer, "clean_data/20240614_sxfer.csv")
